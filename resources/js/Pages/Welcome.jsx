                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="mb-6 md:mb-0">
                            <h3 className="text-2xl font-black mb-2">
                                <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent hover:from-emerald-300 hover:to-teal-300 transition-all duration-300 cursor-default">
                                    2025 Jia Ying
                                </span>
                            </h3>
                            <p className="text-gray-400">Premium Global Procurement Services</p>
                        </div>
                        <div className="flex space-x-8">
                            <Link href="/about" className="text-gray-400 hover:text-emerald-400 hover:scale-110 transform transition-all duration-200">About</Link>
                            <Link href="/services" className="text-gray-400 hover:text-emerald-400 hover:scale-110 transform transition-all duration-200">Services</Link>
                            <Link href="/contact" className="text-gray-400 hover:text-emerald-400 hover:scale-110 transform transition-all duration-200">Contact</Link>
                            <Link href="/privacy" className="text-gray-400 hover:text-emerald-400 hover:scale-110 transform transition-all duration-200">Privacy</Link>
                        </div>
                    </div>
                    <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
                        <p className="hover:text-emerald-400 transition-colors duration-300">&copy; 2025 Jia Ying. All rights reserved. | Excellence in Global Commerce</p>
                    </div>
                </div>
            </footer>
        </div>
