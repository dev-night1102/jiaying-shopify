            ...
            <div className="relative space-y-8">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 p-8 shadow-2xl animate-slide-down">
                    ...
                    <div className="relative flex items-center justify-between">
                        ...
                        <Link 
                            href="/orders/create" 
                            className="group relative inline-flex items-center px-6 py-3 bg-white text-purple-600 font-semibold rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden"
                        >
                            <span className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 group-hover:opacity-10 transition-opacity duration-300"></span>
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <div className="flex-1">
                            <div className="relative group">
                                <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-gray-400 group-focus-within:text-purple-600 transition-colors duration-200" />
                                <input
                                    type="text"
                                    placeholder={t('Search by order number, product, or link...')}
                                    className="input pl-12 pr-4 py-3 w-full border-2 border-gray-200 focus:border-purple-500 rounded-xl transition-all duration-200 hover:border-gray-300"
                                    value={search}
                        ...
                        <div className="sm:w-64">
                            <div className="relative">
                                <select
                                    className="input px-4 py-3 pr-10 w-full border-2 border-gray-200 focus:border-purple-500 rounded-xl appearance-none cursor-pointer transition-all duration-200 hover:border-gray-300 font-medium"
                                    value={status}
                        ...
                        <button 
                            ...
                            className="btn bg-gradient-to-r from-purple-600 to-pink-600 text-white hover:from-purple-700 hover:to-pink-700 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
                        >
